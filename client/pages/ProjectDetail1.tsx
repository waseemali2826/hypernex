    ...
    <div className="min-h-screen bg-black scroll-smooth">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <nav className="hidden md:flex items-center gap-6 lg:gap-8">
              ...
              <a href="/contact-us" className="text-sm text-gray-300 hover:text-[#21BFFF] transition">Contact Us</a>
            </nav>
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden p-2 text-gray-300 hover:text-[#21BFFF]">
      ...
      <div className="pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16 px-3 sm:px-4 lg:px-8 border-b border-[#21BFFF]/20">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-4">Barber Salon</h1>
          <div className="flex items-center justify-center gap-2 text-gray-400">
            <a href="/portfolio" className="hover:text-[#21BFFF] transition">Portfolio</a>
            <span>/</span>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-3 sm:px-4 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="rounded-lg overflow-hidden mb-12">
            <img src="https://cdn.builder.io/api/v1/image/assets%2F516737e8775e484aa78bfadffa78b91e%2Fc9d6eee60f574985816984a3cd73c2e1?format=webp&width=800" alt="Hollywood Hair Salon" className="w-full h-auto object-cover" />
          </div>

          <div className="grid md:grid-cols-3 gap-8 sm:gap-10 mb-12">
            <div>
              <h3 className="text-sm font-bold text-[#21BFFF] mb-3 tracking-widest">PROJECT DETAILS</h3>
              <p className="text-white text-sm">Hollywood Hair Salon</p>
            </div>
            <div>
              <h3 className="text-sm font-bold text-[#21BFFF] mb-3 tracking-widest">CLIENT</h3>
              <p className="text-white text-sm">Premium Hair Salon</p>
            </div>
            <div>
              <h3 className="text-sm font-bold text-[#21BFFF] mb-3 tracking-widest">SERVICES</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 sm:gap-10 mb-12 items-start">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 text-sm sm:text-base mb-4">The Hollywood Hair Saloon website should therefore be a contemporary, easy-to-use website that shows the services , the stylists, and the saloon’s uniqueness.</p>
              <p className="text-gray-300 text-sm sm:text-base">Our goal was that the website would center around the client's experience by using a clean, easy-to-follow layout with all their focus on booking and offers and sales. This would be very essential in achieving aesthetic design as well as functionality in trying to summarize the brand of the saloon.</p>

              <div className="mt-6 flex justify-center">
                <img src="https://cdn.builder.io/api/v1/image/assets%2F261dc11908494c5bafcd987f6ce1fadf%2Fccf05ee3093d460e8bc4c51dffa4ff8c?format=webp&width=800" alt="Project objective illustrative" className="w-full max-w-2xl rounded-lg object-cover shadow-md" />
              </div>
            </div>
